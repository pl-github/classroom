...
namespace Classroom\PhpAnalyzerBundle\Tests\Phpcpd;
...
use Classroom\PhpAnalyzerBundle\Phpcpd\PhpcpdProcessor;
...
EOL;
        ...
        $collectorMock = $this->getMockBuilder('Classroom\PhpAnalyzerBundle\Phpcpd\PhpcpdCollector')
