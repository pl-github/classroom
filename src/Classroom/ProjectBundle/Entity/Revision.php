...
namespace Classroom\ProjectBundle\Entity;

use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity
 * @ORM\Table(name = "classroom_project_revision", indexes = {
...
class Revision
{
    ...
    /**
     * @var Project
     * @ORM\ManyToOne(targetEntity="Classroom\ProjectBundle\Entity\Project")
     * @ORM\JoinColumns({
