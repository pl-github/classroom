...
class NodeController extends Controller
{
    ...
    /**
     * @Route("/metrics", name="classroom_node_metrics")
     * @Template()
     */
    ...
    /**
     * @Route("/smells", name="classroom_node_smells")
     * @Template()
     */
    ...
    /**
     * @Route("/annotations", name="classroom_node_annotations")
     * @Template()
     */
